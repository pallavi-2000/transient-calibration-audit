...
\citep{Sanchez-Saez2021, Pavez-Herrera2025} for multi-class
transient classification using Random Forest on extracted
photometric features. Fink \citep{Moller2021} provides a modular 
...
\citep{Platt1999} and isotonic regression provide effective
corrections. \citet{Zadrozny2002} introduced isotonic
regression as a nonparametric post-hoc calibration method
applicable to any classifier; \citet{Kull2017} proposed beta
calibration for binary scores, and \citet{Kull2019} extended
matrix/Dirichlet scaling to the multiclass setting. The
sensitivity of ECE itself to bin construction is analysed by
\citet{Nixon2019} and \citet{Roelofs2022}, motivating the
adaptive-binning robustness checks we perform in
Section~\ref{sec:results:binning}.
